...
chemdb_queue_nwchem     = HeteroFAM_HOME + "/bin/chemdb_queue_nwchem "
chemdb_fetch_esmiles5   = HeteroFAM_HOME + "/bin/chemdb_fetch_esmiles5 "
chemdb_image0           = HeteroFAM_HOME + "/bin/chemdb_image0 -f "
chemdb_eric             = HeteroFAM_HOME + "/bin/chemdb_eric  "
chemdb_eric2            = HeteroFAM_HOME + "/bin/chemdb_eric2 "
chemdb_osra             = HeteroFAM_HOME + "/bin/chemdb_osra  "
...
templatedir2            = HeteroFAM_HOME + "/Public/templates2"
staticdir               = HeteroFAM_HOME + "/Public/static"
staticdir2              = HeteroFAM_HOME + "/Public/static2"
reactiondir             = HeteroFAM_HOME + "/Public/reaction"
chemdbdir               = HeteroFAM_HOME + "/Public/chemdb_hold"
counterdir              = HeteroFAM_HOME + "/Public/counters"
namecount = 0
...
headerfigure = [ '<a href="{{url_for(\'static\', filename=\'arrows-static/banner2.gif\')}}"><img src="{{url_for(\'static\', filename=\'arrows-static/banner2.gif\')}}" alt="HeteroFAM Banner Movie"> </a>', '<a href="{{url_for(\'static\', filename=\'arrows-static/EMSL_banner.jpeg\')}}"><img src="{{url_for(\'static\', filename=\'arrows-static/EMSL_banner.jpeg\')}}" alt="EMSL Computing Banner" height="162" width="450" border=0 /></a>', '<a href="{{url_for(\'static\', filename=\'arrows-static/Surface-uprot.gif\')}}"><img src="{{url_for(\'static\', filename=\'arrows-static/Surface-uprot.gif\')}}" alt="HeteroFAM Movie" width="200" height="200"> </a>', '<a href="{{url_for(\'static\', filename=\'arrows-static/HeteroFAMBeaker2.gif\')}}"><img src="{{url_for(\'static\', filename=\'arrows-static/HeteroFAMBeaker2.gif\')}}" alt="HeteroFAM Movie"> </a>' ]
...
_audit_creation_method    generated by EMSL HeteroFAM
...
def list_queue_nwchem_html():
   ...
   for ln in calcs.split("\n"):
      ...
      if (len(ss)==0):
         ...
         dentr  = HeteroFAM_API_HOME + "queue_nwchem_delete/"+ss[0]
         hlink  = "<a href=\"" + link + "\">%s</a> " % ss[0]
...
def arrows_draw_form():
   ...
   avisits = apivisited()
   return render_template("JSME-heterofam.html",heterofam_api=HeteroFAM_API_HOME,calculations=calcs,moleculecalculations=molcalcs,visits=avisits)
...
def arrows_qsharp_chem_draw_form():
   ...
   molcalcs = calculationscount()
   avisits = apivisited()
   return render_template("Qsharp-chem-arrows.html",heterofam_api=HeteroFAM_API_HOME,calculations=calcs,moleculecalculations=molcalcs,visits=avisits)
...
def eric_form():
   increment_apivisited()
   return render_template("eric-input.html",heterofam_api=HeteroFAM_API_HOME)
...
def eric_form2():
   ...
   return render_template("eric-input2.html",heterofam_api=HeteroFAM_API_HOME,calculations=calcs,moleculecalculations=molcalcs,visits=avisits)
...
def eric_form4():
   ...
   molcalcs = calculationscount()
   avisits = apivisited()
   return render_template("eric-input4.html",heterofam_api=HeteroFAM_API_HOME,calculations=calcs,moleculecalculations=molcalcs,visits=avisits)
...
def dagrereaction_form():
   ...
   avisits = apivisited()
   #return render_template("eric-input2.html")
   return render_template("dagre-rxn.html",heterofam_api=HeteroFAM_API_HOME,calculations=calcs,moleculecalculations=molcalcs,visits=avisits)
